...
struct SupportSheet: View {
    ...
    private var humanityStateDescription: String {
        ...
        case .readyForWalletDocument: return "ready to read from Wallet"
        case .scanningWalletDocument: return "reading from Wallet"
        case .walletDocumentReady: return "Wallet ID read, ready to verify"
