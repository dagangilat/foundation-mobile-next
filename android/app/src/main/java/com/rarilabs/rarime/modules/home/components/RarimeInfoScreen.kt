...
fun RarimeInfoScreen(onClose: () -> Unit) {
    HomeIntroLayout(
        ...
        title = stringResource(R.string.what_is_foundation_title)
    ) {
        Column(
            ...
            Column(verticalArrangement = Arrangement.spacedBy(16.dp)) {
                DescriptionStepRow(text = stringResource(R.string.what_is_foundation_text_item_1))
                DescriptionStepRow(text = stringResource(R.string.what_is_foundation_text_item_2))
                DescriptionStepRow(annotatedText = buildAnnotatedString {
                    withStyle(
                        ...
                        append(stringResource(R.string.what_is_foundation_text_item_3_accent))
                    }
                    append(stringResource(R.string.what_is_foundation_text_item_3))
                })
            }
            PrimaryButton(
