...
/// **Pre-flight**
///
/// This file requires the iOS bundle ID `com.foundationglobal.mobile`
/// to be registered with App Attest + DeviceCheck in the
/// `solanavote-devnet` Firebase Console, and the simulator's debug
/// token registered in the App Check debug-tokens list. See
/// `foundation-global/docs/runbook_app-check-firebase-console-2026-04-28.md`
/// steps 1-2 for the exact Console clicks.
///
