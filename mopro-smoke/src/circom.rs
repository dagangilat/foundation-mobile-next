// Copied from mopro-cli 0.3.5 src/template/init/src/circom.rs. The upstream
// mopro-cli generates this file into every user project that selects the
// Circom adapter, rather than exposing it from the `mopro-ffi` crate directly
// — that's why we can't just flip a feature flag.
//
// Do NOT edit this file casually; diffs against upstream make future mopro
